...
. <(wget -qO- https://github.com/leyung/shutuSeedbox/raw/main/component/seedbox_component.sh)
...
. <(wget -qO- https://github.com/leyung/shutuSeedbox/raw/main/shell/qb-nox-static.sh)
